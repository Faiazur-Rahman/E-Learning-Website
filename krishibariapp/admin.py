...
class UserCreationForm(forms.ModelForm):
    ...
    class Meta:
        model = Dbtable
        fields = ('email','name','phone','perAddress','currAddress','NID','password')
...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        ('Personal info', {'fields': ('name','phone','perAddress','currAddress','NID')}),
        ('Permissions', {'fields': ('is_admin','is_subAdmin','is_staff','is_active',)}),
    )
...
admin.site.register(Dbtable, UserAdmin)
